...
// Same as validBuffer, but 0x61 is now 0x62 @ i = 4
const invalidBuffer = Buffer.from([0x42, 0x45, 0x5e, 0x34, 0x62, 0xf6, 0xff, 0x00, 0x00, 0x74, 0x65, 0x73, 0x74]);

// These are intentionally out of order, occasionally packets will be received this way
const largePacket = [
